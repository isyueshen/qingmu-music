...
public class GlideCacheUtil {
     ...
     * @return CacheSize
     */
    public String getInternalCacheSize() {
        try {
    ...
    public String getExternalCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(context.getExternalCacheDir(), InternalCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
