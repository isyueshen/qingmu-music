...
public class DialogPlayListAdapter extends RecyclerView.Adapter<DialogPlayListAdapter.MViewHolder> {
    private static final String TAG = "DialogPlayListAdapter";
    /**
     * 数据
     */
    ...
    public DialogPlayListAdapter(List<Song> songList) {
        // 非法传值
        if (songList == null) {
